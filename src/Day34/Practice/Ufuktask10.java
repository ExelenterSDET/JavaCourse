...
public class Ufuktask10 {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<String> arrlist=new ArrayList<>(Arrays.asList("Boston","NewYork","San-Francisco"));

//        removeCitiesFromList(arrlist,'n');
        removeCitiesFromMap(map);
    }
    static ArrayList<String> removeCitiesFromList(ArrayList<String> list, Character ch){
        list.removeIf(n->n.toUpperCase().charAt(0)==Character.toUpperCase(ch));
//        System.out.println("list = " + list);
        return list;
    }

    static HashMap<String, ArrayList<String>> removeCitiesFromMap(HashMap<String, ArrayList<String>> hashMap){
