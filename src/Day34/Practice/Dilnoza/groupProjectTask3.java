...
public class groupProjectTask3 {
  ...
  public static void main(String[] args) {
        ArrayList<Integer> mainList= new ArrayList<>(Arrays.asList(5, 4, 2, 1, 0, 3));
        System.out.println(sortedArray(mainList));

    }

  static  ArrayList<Integer> sortedArray(ArrayList<Integer> list){
