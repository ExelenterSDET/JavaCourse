...
public class Homework {
    ...
    public static void main(String[] args) {
        ...
        HashSet<String> Physics= new HashSet<>((Arrays.asList("James","Dilnoza","Andrea","James","Malika","Ufuk","Sam")));
        HashSet<String> Math= new HashSet<>((Arrays.asList("Arthur","Kim","Malika","Anthony","Peter","Kim","Katie","Marina")));
