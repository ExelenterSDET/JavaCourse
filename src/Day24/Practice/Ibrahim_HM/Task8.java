...
public class Task8 {
   ...
   it returns [1,6,12,-1,22,-1,30,-1]
    ...
    static int[] updateRange(int[] iArr, int lowerbound, int upperbound){

        for (int i = 0; i < iArr.length; i++) {
            if (lowerbound < iArr[i] && iArr[i] < upperbound){
                iArr[i] = -1;
            }
        }
        return iArr;
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(updateRange(array, lowerbound, upperbound)));
    }
}
