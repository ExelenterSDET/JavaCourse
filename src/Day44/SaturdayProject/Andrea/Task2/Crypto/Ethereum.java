...
public class Ethereum {
    ...
    private final double price = 1329.17; //---> should be accessible only within the same class. should be constant. Note: value for Bitcoin clas is 19540.09 and for Ethereum class is 1329.17
    public double transactionValue; //---> should be instance attribute and accessible in all packages.
    public final String shortname = "ETH"; //   ---> should be accessible in all packages. should be class attribute. should be constant: "BTC" for Bitcoin and "ETH" for Ethereum
